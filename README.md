...
a.
The game takes place on an 8x8 grid, having marked columns (1-8) and rows (A-H). 
...
> warp B3, followed by warp E3, followed by warp H6 (if no enemy ships are on those squares)
> cheat
